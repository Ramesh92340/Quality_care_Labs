    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="<?= base_url(); ?>add/stocks">Edit Test</a></div>
                    ...
                    <div class="card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?= form_open_multipart('update/test'); ?>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Test Name</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="test_name" value="<?= $test['test_name']; ?>">
                                        <input type="hidden" class="form-control" name="id" value="<?= $test['id']; ?>">
                                        <input type="hidden" class="form-control" name="cat_id" value="<?= $test['category_id']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
