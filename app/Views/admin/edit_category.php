    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="<?= base_url(); ?>add/stocks">edit Category</a></div>
                    ...
                    <div class="card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?= form_open_multipart('update/category'); ?>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Category Name</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="cat_name" value="<?= $cate2['name'] ?>">
                                        <input type="hidden" class="form-control" name="id" value="<?= $cate2['id'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                        ...
                                        <select name="package" id="" class="form-control">
                                            <?php if (isset($pack)) : ?>
                                                <?php foreach ($pack as $pk) : ?>
                                                    <?php if (!empty($cate2['package']) && $cate2['package'] == $pk['id']) : ?>
                                                        <!-- Selected option -->
                                                        <option value="<?= $pk['id'] ?>" selected><?= $pk['package_name'] ?></option>
                                                    <?php else : ?>
                                                        <!-- Other options -->
