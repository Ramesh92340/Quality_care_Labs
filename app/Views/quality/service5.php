            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-srv-process mb-30">
                     <h4 class="tp-srv-process__title mb-10">Microbiology</h4>
                     <p class="mb-20">Timely and accurate identification of pathogens is crucial in managing infections.
                        Our microbiology services encompass a broad range of tests, covering bacterial, fungal, and
                        viral pathogens. Using advanced culture techniques, molecular assays, and antimicrobial
                        susceptibility testing, we provide reliable results to guide appropriate treatment decisions and
                     ...
                     <div class="tp-srv-process__list">
                        ...
                        <ul>
                           <li><i class="fa-solid fa-check"></i> "Explore Our Microbiology Services" </li>
                           <li><i class="fa-solid fa-check"></i> "Accurate Pathogen Identification for Optimal
                              Treatment" </li>
                           <li><i class="fa-solid fa-check"></i> "Ensure Effective Infection Control with Reliable
                              Microbiology Results" </li>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-srv-research mb-30">
                     ...
                     <p>In our investigation, we aim to delve deeper into the field of microbiology and its crucial role
                        in healthcare. We will explore the test process in detail, focusing on four essential steps:</p>
                  </div>
               </div>
            </div>
               ...
               <div class="col-lg-12">
                  <div class="tp-srv-stap mb-20">
                     ...
                     <p>1.Sample Collection:
                        ...
                        We will scrutinize the significance of proper sample collection techniques in microbiology to
                        ensure precise and reliable results. This includes discussing specific methods tailored for
                        various sample types, such as swabs for bacterial cultures or specimens for viral
                        identification.</p>
                     <p>2.Sample Handling and Preparation:

                        Our research will underscore the critical importance of proper sample handling and preparation
                        procedures in microbiology. We will delve into the steps involved in processing samples,
                        including culturing, staining, and preserving conditions, to maintain the viability of
                        microorganisms and prevent contamination.</p>

                     <p> 3.Laboratory Analysis:

                        We will investigate the diverse range of microbiological techniques and instruments employed in
                        testing. This involves discussing the principles behind common methods such as polymerase chain
                        reaction (PCR), microbial cultures, and sensitivity testing, as well as exploring cutting-edge
                        technologies and advancements in the microbiology field.</p>

                     <p> 4.Result Interpretation and Reporting:

                        Our research will highlight the pivotal role of accurate result interpretation and reporting in
                        microbiology. We will explore the responsibilities of trained laboratory professionals in
                        analyzing microbiological data, considering established standards, and providing meaningful
                        insights to healthcare providers for effective diagnosis, treatment decisions, and patient care.
                     </p>

                     <p> By conducting a comprehensive exploration of these aspects, our goal is to offer valuable
                        insights into the microbiology testing process and underscore the importance of precise and
                        dependable results in delivering quality healthcare. </p>
                  </div>
               </div>
         ...
         <div class="table-responsive" style="max-height:500px; overflow-y: auto;">
             ...
             <table>
               ...
               <tr>
                  ...
                  <td>PARASITES FOR SCISTOSOMA </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
               ...
               <tr>
                  ...
                  <td>AFB Culture & Sensitivity (Conventional) </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
               ...
               <tr>
                  ...
                  <td>BLOOD FOR CULTURE & SENSTIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
               ...
               <tr>
                  ...
                  <td>CENTRAL LINE TIP FOR CULTURE AND SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center"> 500.00</td>
               ...
               <tr>
                  ...
                  <td>CRYPTOCOCCUS ANTIGEN-CSF </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
               ...
               <tr>
                  ...
                  <td>CSF FOR CULTURE & SENSTIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
               ...
               <tr>
                  ...
                  <td>Diphtheria Culture and Sensitivity </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
               ...
               <tr>
                  ...
                  <td>ET TIP / ASPIRATE FOR CULTURE AND SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
               ...
               <tr>
                  ...
                  <td>FLUID FOR CULTURE & SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
               ...
               <tr>
                  ...
                  <td>Lactophenol Cotton Blue (LPCB) Staining </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
               ...
               <tr>
                  ...
                  <td>MICROBIOLOGY WATER ANALYSIS </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
               ...
               <tr>
                  ...
                  <td>NAIL SWAB FOR CULTURE AND SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
               ...
               <tr>
                  ...
                  <td>PUS FOR CULTURE & SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00 </td>
               ...
               <tr>
                  ...
                  <td>SARA COV - 2 IGG II Quantitative </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
               ...
               <tr>
                  ...
                  <td>SEMEN FOR CULTURE AND SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">400.00</td>
               ...
               <tr>
                  ...
                  <td>SPUTUM FOR CULTURE AND SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">400.00</td>
               ...
               <tr>
                  ...
                  <td>STOOL FOR CULTURE & SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
               ...
               <tr>
                  ...
                  <td>STOOL HANGING DROP TECHNIQUE </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">200.00</td>
               ...
               <tr>
                  ...
                  <td>THROAT SWAB FOR CULTURE AND SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
               ...
               <tr>
                  ...
                  <td>TISSUE FOR CULTURE AND SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00 </td>
               ...
               <tr>
                  ...
                  <td>URINE FOR CULTURE & SENSTIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00 </td>
               ...
               <tr>
                  ...
                  <td>VAGINAL SWAB FOR CULTURE AND SENSITIVITY </td>
                  <td> DEPARTMENT OF MICROBIOLOGY
                  </td>
                  <td class="text-center">500.00</td>
