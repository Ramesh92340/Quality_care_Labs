...
<body>
   ...
   <!-- sidebar-info-end -->
    ...
    <main>
        ...
        <!-- checkout-area start -->
        <section class="checkout-area pb-100 wow fadeInUp only_margin_top" data-wow-duration=".8s" data-wow-delay=".2s">
            <div class="container">
                <form action="#">
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="checkbox-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12  ">
                                        <div class="row p-3">
                                            <button class="login-bottom-btn" style="border-radius: 8px;">login</button>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkout-form-list create-acc">
                                            ...
                                            <label>Don't have an account? <a href="register.html" class="register_color"> Register  </a></label>
                                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 d-flex flex-column justify-content-center d-none d-lg-block ">
