      ...
      <section class="mt-50 mb-50">
         <div class="container" id="privacy">
            ...
            <ul>
               ...
               <li>
                  <p><strong>Website</strong> refers to Quality Care Labs, accessible from <a href="https://qualitycarelabs.in" rel="external nofollow noopener" target="_blank">https://qualitycarelabs.in</a></p>
               </li>
               <li>
            ...
            <ul>
               ...
               <li>
                  <p>By visiting this page on our website: <a href="https://qualitycarelabs.in" rel="external nofollow noopener" target="_blank">https://qualitycarelabs.in</a></p>
               </li>
               <li>
