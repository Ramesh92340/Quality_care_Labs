...
<body>
   ...
   <main>
      ...
      <section>
         <div class="img_body">
            <img class="title-image" src="<?= base_url() ?>assets/img/Clinical-bio-chemistry.png" alt="Title Image">
            ...
            <div class="row">
               <div class="col-lg-6 col-md-12">
                  <div class="services-thumb-img mb-30 wow fadeInLeft" data-wow-delay=".4s">
                     <img src="<?= base_url() ?>assets/img/Clinical-bio-chemistry-image-1.png" alt="services-thumb" class="img-fluid">
                  </div>
               </div>
               <div class="col-lg-6 col-md-12">
                  <div class="services-thumb-img mb-30 wow fadeInRight" data-wow-delay=".4s">
                     <img src="<?= base_url() ?>assets/img/Clinical-bio-chemistry-image-2.png" alt="services-thumb" class="img-fluid">
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-srv-process mb-30">
                     <h4 class="tp-srv-process__title mb-10 ">CLINICAL BIO CHEMIATRY</h4>
                     <p class="mb-20">Accurate analysis of biochemical markers plays a vital role in disease diagnosis
                        and monitoring. Our clinical biochemistry services utilize the latest technology to assess
                        different parameters such as blood glucose, lipid profile, liver function, kidney function, and
                        more. With our precise and timely results, healthcare professionals can make informed decisions,
                        ensuring effective patient management.</p>
                     ...
                     <div class="tp-srv-process__list">
                        ...
                        <ul>
                           <li><i class="fa-solid fa-check"></i> "Explore Our Clinical Biochemistry Services" </li>
                           <li><i class="fa-solid fa-check"></i> "Access Reliable Biochemical Analysis" </li>
                           <li><i class="fa-solid fa-check"></i> "Enhance Patient Care with Accurate Biochemistry
                              Results" </li>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-srv-research mb-30">
                     ...
                     <p>In our research, we aim to delve deeper into the field of clinical biochemistry and its
                        significance in healthcare. We will explore the test process in detail, focusing on four simple
                        steps:</p>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-srv-stap mb-20">
                     ...
                     <p>1. Sample Collection: We will investigate the importance of proper sample collection techniques
                        to ensure accurate and reliable results. This will include discussing specific collection
                        methods for different types of samples, such as venipuncture for blood or clean-catch urine
                        collection.</p>
                     <p>2. Sample Handling and Preparation: Our research will emphasize the criticality of proper sample
                        handling and preparation procedures. We will explore the steps involved in sample processing,
                        such as centrifugation, separation, and storage conditions, to maintain sample integrity and
                        prevent degradation. </p>

                     <p> 3. Laboratory Analysis: We will examine various biochemical techniques and instruments used in
                        clinical biochemistry testing. This will involve discussing the principles behind common methods
                        like spectrophotometry and immunoassays, as well as exploring emerging technologies and
                        advancements in the field.</p>

                     <p> 4. Result Interpretation and Reporting: Our research will emphasize the significance of
                        accurate result interpretation and reporting. We will explore the role of trained laboratory
                        professionals in analyzing the data, considering reference ranges, and providing meaningful
                        insights to healthcare providers for diagnosis, treatment decisions, and patient care.</p>

                     <p> By conducting comprehensive research on these aspects, we aim to provide valuable insights into
                        the test process in clinical biochemistry and highlight the importance of accurate and reliable
                        results in delivering quality healthcare. </p>
                  </div>
               </div>
         ...
         <div class="table-responsive" style="max-height:500px; overflow-y: auto;">
            ...
            <table>
               ...
               <tr>
                  ...
                  <td data-test-code>ALCOHOL
                  </td>

                  <td data-test-name> ALCOHOL SCREENING </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center" data-price>1000.00 </td>
               ...
               <tr>
                  ...
                  <td class="text-center"> <i class="fa-solid fa-cart-arrow-down"></i></td>
               </tr>
               ...
               <tr>
                  ...
                  <td> (1, 3)-BETA-D-GLUCAN (BDG) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 13000.00 </td>
               ...
               <tr>
                  ...
                  <td> 17-alpha Hydroxy Progesterone (17-OHP) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
               ...
               <tr>
                  ...
                  <td> 24 HRS URINE CATECHOLAMINES </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
               ...
               <tr>
                  ...
                  <td> 24 HRS URINE FREE CORTISOL </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 800.00 </td>
               ...
               <tr>
                  ...
                  <td> 24HRS URINE FOR URIC ACID </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td> 5-Alpha-Dihydrotestosterone </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3000.00 </td>
               ...
               <tr>
                  ...
                  <td> 5-HIAA (5-HYDROXY INDOLE ACETIC ACID), 24 HOUR URINE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3500.00 </td>
               ...
               <tr>
                  ...
                  <td> ACETYL CHLOINE RECEPTOR AB </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4900.00 </td>
               ...
               <tr>
                  ...
                  <td> ADENOSINE DEAMINASE (ADA) - Ascitic Fluid </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 600.00 </td>
               ...
               <tr>
                  ...
                  <td> ADENOSINE DEAMINASE (ADA) - CSF </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 600.00 </td>
               ...
               <tr>
                  ...
                  <td> ADENOSINE DEAMINASE (ADA) - Pericardial Fluid </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 600.00 </td>
               ...
               <tr>
                  ...
                  <td> ADENOSINE DEAMINASE (ADA) - Pleural Fluid </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 600.00 </td>
               ...
               <tr>
                  ...
                  <td> ADENOSINE DEAMINASE (ADA) - Pus </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 600.00 </td>
               ...
               <tr>
                  ...
                  <td> ADENOSINE DEAMINASE (ADA) - SERUM </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 600.00 </td>
               ...
               <tr>
                  ...
                  <td> ALKAPTONURIA, URINE, QUANTITATIVE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td> ALLERGY NUT PANEL </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4000.00 </td>
               ...
               <tr>
                  ...
                  <td> ALPHA FETO PROTEIN </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 850.00</td>
               ...
               <tr>
                  ...
                  <td> Androstenedione (A4) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 2200.00 </td>
               ...
               <tr>
                  ...
                  <td> Anti Diuretic Hormone - ADH </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4500.00 </td>
               ...
               <tr>
                  ...
                  <td> Anti Microsomal/Thryroperoxidase Antibody (AMA/Anti TPO) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> Anti Sperm Antibody - Serum </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> ANTI THROMBIN III (ANTIGENIC) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
               ...
               <tr>
                  ...
                  <td>ARTERIAL BLOOD GAS WITH ELECTROLYTES </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> BETA ­2­ TRANSFERRIN, FLUID </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 5500.00 </td>
               ...
               <tr>
                  ...
                  <td>Beta 2- Glycoprotein 1-IgG - Serum </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1200.00 </td>
               ...
               <tr>
                  ...
                  <td> Beta 2- Glycoprotein 1-IgM - Serum </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1200.00 </td>
               ...
               <tr>
                  ...
                  <td> BIOCHEMICAL ANALYSIS FOR FLUIDS </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td> BIOCHEMICAL ANALYSIS - ASCITIC FLUID </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
               ...
               <tr>
                  ...
                  <td> BIOCHEMICAL ANALYSIS - PERICARDIAL FLUID </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 600.00 </td>
               ...
               <tr>
                  ...
                  <td> BLOOD FOR TOXICOLOGY
                  </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3500
                  </td>
               ...
               <tr>
                  ...
                  <td> C - PEPTIDE STIMULATION TEST </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> C 1 ESTERASE INHIBITOR </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 2800.00 </td>
               ...
               <tr>
                  ...
                  <td> C 1 ESTERASE INHIBITOR FUNCTIONAL ACTIVITY </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 7000.00 </td>
               ...
               <tr>
                  ...
                  <td> CA 19.9 - PANCREATIC CANCER MARKER </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> CA 72.4 Cancer Marker - Serum </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 2000.00 </td>
               ...
               <tr>
                  ...
                  <td> CA125 - Ovarian Cancer marker - fluid </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> CA15.3 - Breast Cancer marker </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1500.00 </td>
               ...
               <tr>
                  ...
                  <td> CARBONDIOXIDE , TOTAL - SERUM / PLASMA </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td> CH 50 COMPLEMENT TOTAL SERUM -1599 </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4700.00 </td>
               ...
               <tr>
                  ...
                  <td> Creatinine Clearence Test </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td> Cyclosporine ,by LC-MS/MS </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3000.00 </td>
               ...
               <tr>
                  ...
                  <td> Dehydroepiandrosterone Sulphate (DHEAS) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> DIABETES TYPE 1, AUTOIMMUNE PROFILE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 10500.00</td>
               ...
               <tr>
                  ...
                  <td> Erythropoietin (EPO) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1550.00 </td>
               ...
               <tr>
                  ...
                  <td> Ferritin - Serum (RANBAXY) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 950.00 </td>
               ...
               <tr>
                  ...
                  <td> FLUID BIOCHEMICAL ANALYSIS - CSF </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00</td>
               ...
               <tr>
                  ...
                  <td> Fluid Biochemical Examination </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td> FREE ANDROGEN INDEX - ranbaxy </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4000.00 </td>
               ...
               <tr>
                  ...
                  <td> FREE LIGHT CHAINS(KAPPA & LAMBEDA) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 2500.00 </td>
               ...
               <tr>
                  ...
                  <td> GAD­65 GLUTAMIC ACID </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">6500.00</td>
               ...
               <tr>
                  ...
                  <td> GFR Estimation Using the MDRD Equation </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td> GLUCOSE CHALANGE TEST (G.C.T) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 250.00 </td>
               ...
               <tr>
                  ...
                  <td> Haptoglobulin </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1700.00 </td>
               ...
               <tr>
                  ...
                  <td> Haptoglobulin - Ranbaxy -15191 </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">4500.00 </td>
               ...
               <tr>
                  ...
                  <td> HCG BETA, TOTAL, TUMOR MARKER, </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 800.00 </td>
               ...
               <tr>
                  ...
                  <td> HE4; HUMAN EPIDIDYMIS PROTEIN 4 </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 2500.00 </td>
               ...
               <tr>
                  ...
                  <td> HELICOBACTER PYLORI ANTIGEN, STOOL TEST </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">1000.00 </td>
               ...
               <tr>
                  ...
                  <td> High Sensitive (hsCRP) - Serum </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> HOMA-IR ; INSULIN RESISTANCE INDEX </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1500.00 </td>
               ...
               <tr>
                  ...
                  <td> IGF BINDING PROTEIN ­ 3; IGFBP ­3 </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">5500.00</td>
               ...
               <tr>
                  ...
                  <td> Immunofixation Electrophoresis </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
               ...
               <tr>
                  ...
                  <td>IMMUNOGLOBULIN IgG SYNTHESIS INDEX & RATE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4500.00 </td>
               ...
               <tr>
                  ...
                  <td> IMMUNOPHENOTYPING BY FLOW CYTOMETRY: CD19 </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">3000.00 </td>
               ...
               <tr>
                  ...
                  <td> INSULIN GROWTH FACTOR LEVEL </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4500.00 </td>
               ...
               <tr>
                  ...
                  <td> INTRINSIC FACTOR IgG - RANBAXY </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">2600.00 </td>
               ...
               <tr>
                  ...
                  <td> Intrinsic Factor IgG Antibody </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">3000.00 </td>
               ...
               <tr>
                  ...
                  <td> Islet Cell Antibody - Serum </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">3000.00 </td>
               ...
               <tr>
                  ...
                  <td> Lactate Dehyderogenase (LDH) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td>Lactate Dehyderogenase (LDH) - Pleural Fluid </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td> METABOLIC PROFILE A - THYROCARE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 7000.00</td>
               ...
               <tr>
                  ...
                  <td> METABOLIC SCREENINGPANEL - 1 </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1200.00 </td>
               ...
               <tr>
                  ...
                  <td> METABOLIC SCREENINGPANEL - 2 </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 2000.00 </td>
               ...
               <tr>
                  ...
                  <td> MICROALBUMIN : CREATININE RATIO, URINE</td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 500.00 </td>
               ...
               <tr>
                  ...
                  <td>MULTIPLE MYELOMA SCREENING PANEL </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
               ...
               <tr>
                  ...
                  <td> NBS - Inborn Metabolic Disorders (IMD) Panel - TMS </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 5000.00 </td>
               ...
               <tr>
                  ...
                  <td> NBS - Inborn Metabolic Disorders (IMD) Panel -GCMS </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 6000.00 </td>
               ...
               <tr>
                  ...
                  <td> NON - METANENEPHRINES - URINE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 2500.00 </td>
               ...
               <tr>
                  ...
                  <td> Nor Metanephrines-Free-Plasma </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3300.00 </td>
               ...
               <tr>
                  ...
                  <td> Oligoclonalbands </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 5700.00 </td>
               ...
               <tr>
                  ...
                  <td> Oral Glucose Tolerance Test (O-GTT) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 300.00 </td>
               ...
               <tr>
                  ...
                  <td> Oral Glucose Tolerance Test for Insulin (O-GTT) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3000.00 </td>
               ...
               <tr>
                  ...
                  <td> PHOSPHORUS, INORGANIC - SPOT URINE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 300.00 </td>
               ...
               <tr>
                  ...
                  <td> PLASMA RENIN </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 6700.00 </td>
               ...
               <tr>
                  ...
                  <td> Porphobilinogen (Qualitative) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3500.00 </td>
               ...
               <tr>
                  ...
                  <td> PORPHYRINS TOTAL, QUALITATIVE, RANDOM URINE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4500.00 </td>
               ...
               <tr>
                  ...
                  <td> PROSTATIC SPECIFIC ANTIGEN (FREE) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1200.00 </td>
               ...
               <tr>
                  ...
                  <td> PROSTATIC SPECIFIC ANTIGEN (TOTAL) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">750.00 </td>
               ...
               <tr>
                  ...
                  <td> PROTEIN C ASSAY </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 2700.00 </td>
               ...
               <tr>
                  ...
                  <td> SEMEN PREPARATION FOR IUI </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1000.00 </td>
               ...
               <tr>
                  ...
                  <td> Tissue Transglutaminase IgG Antibody - Serum </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1500.00 </td>
               ...
               <tr>
                  ...
                  <td> Total Triiodo Thyronine (T3) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 200.00 </td>
               ...
               <tr>
                  ...
                  <td> TRIPLE SCREEN MARKER TEST </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">2500.00</td>
               ...
               <tr>
                  ...
                  <td> TSH Receptor Antibodies - Serum </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3000.00 </td>
               ...
               <tr>
                  ...
                  <td> TSH STIMULATION BY TRH (THYROTROPIN RELEASING HORMONE) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1500.00 </td>
               ...
               <tr>
                  ...
                  <td> TSH, ULTRASENSITIVE, SERUM (CLIA) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 250.00 </td>
               ...
               <tr>
                  ...
                  <td> URINE FOR REDUCING SUBSTANCES </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 100.00 </td>
               ...
               <tr>
                  ...
                  <td> Vitamin B Complex Profile </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 4500.00 </td>
               ...
               <tr>
                  ...
                  <td> VITAMIN B12; CYANOCOBALAMIN, SERUM </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 800.00 </td>
               ...
               <tr>
                  ...
                  <td> VITAMIN D - RANBAXY </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 1650.00 </td>
               ...
               <tr>
                  ...
                  <td> VITAMIN D, 1, 25-DIHYDROXY </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">3200.00 </td>
               ...
               <tr>
                  ...
                  <td> VMA (Vanillyl Mandelic Acid) </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 3500.00 </td>
               ...
               <tr>
                  ...
                  <td> VORICONAZOLE </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center"> 5200.00 </td>
               ...
               <tr>
                  ...
                  <td> Zinc </td>
                  <td> DEPARTMENT OF CLINICAL BIOCHEMISTRY</td>
                  <td class="text-center">1800.00 </td>
