        ...
        <section>
            ...
            <div class="container margin_top">
                <div class="row">
                    ...
                    <div class='row'>
                        <div class="col-5">
                            <button type="submit" class="update_btn" style="display: none">Update</button>
                        </div>
                        </form>
                        ...
                        <div class="footer-widget footer-col-3 mb-50 wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="footer-widget__info">
                                <ul>
                                    ...
                                    <li><a href="<?= base_url() ?>refundpolicy"><i
                                                class="fa-solid fa-truck"></i>&nbsp;Shipping and Delivery </a></li>
