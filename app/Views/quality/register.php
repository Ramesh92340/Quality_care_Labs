                ...
                <form action="#">
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="checkbox-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12  ">
                                        <div class="row p-3">
                                            <button class="login-bottom-btn" style="border-radius: 8px;">Register</button>
                                        </div>

                                    </div>
                                    <div class="col-md-12">                          
                                        <div class="checkout-form-list create-acc">                               
                                            <label>Already an user? <a href="<?= base_url() ?>login.html" class="register_color"> Login </a></label>
                                        </div>                                                         
                                  </div>
                        ...
                        <div class="col-lg-6 col-md-12   d-none d-lg-block ">
                            <img src="<?= base_url() ?>assets/img/logo (1).png"   class="image_register_size   img-fluid"
                                 alt="...">
                        </div>
                    </div>
                </form>
